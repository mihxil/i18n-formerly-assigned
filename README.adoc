...
This project creates support for 'formerly assigned country codes' (in the form of the enum `org.meeuw.i18n.formerlyassigned.FormerlyAssignedCountryCode` . See https://en.wikipedia.org/wiki/ISO_3166-3.
